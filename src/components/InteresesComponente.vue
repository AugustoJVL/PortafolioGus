<script setup>
    ...
    const intereses = ref([
    'Desarrollo de Software de Código Abierto: Participo activamente en proyectos de GitHub, colaborando con otros desarrolladores para optimizar y mejorar herramientas y bibliotecas populares.',
    'Actividades al Aire Libre: Soy aficionado al senderismo y al ciclismo de montaña, dos actividades que practico con frecuencia para mantener un balance entre mi vida personal y profesional.',
    'Tecnología e Innovación: Me entusiasma estar al tanto de las nuevas tendencias tecnológicas, especialmente en inteligencia artificial y desarrollo de aplicaciones móviles.',
    'Videojuegos: Me apasionan los videojuegos, ya que son una excelente manera de desconectar y explorar mundos virtuales, además de ser una fuente de inspiración y creatividad en mi vida cotidiana.'
    ]);
</script>
